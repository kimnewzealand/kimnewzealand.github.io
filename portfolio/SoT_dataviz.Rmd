...
featuredImage: "img/portfolio/sankey.png"
# showonlyimage : false
weight : 5
---
...
One potential factor is the region of study and if where the student studies is a success factor. This regional grouping consolidates the large number of  **`r length(unique(event$Event.institution))`** institutions for visualisation. 
