...
The chart shows New Zealand startups by their founding year and estimated employee count. Each dot represents a company, hover to see its name. Companies animate in chronological order, oldest to newest.
...
The scatter plots reveal a clear pattern: only a few tech startups ever scale beyond 200 in New Zealand. The companies that do break out are mostly in Auckland, Wellington, and Christchurch. It appears that only two tech startups, Xero and RocketLab, have grown to over 800 employees (worldwide).
