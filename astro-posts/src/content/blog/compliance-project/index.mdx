...
description: "How to automate and manage compliance obligations for a small start up"
date: 2026-06-15
---
...
Digging into the problem statement, the client has the following challenges:
...
The recommendation is to Agentify the obligations management only and to limit AI access to the **obligations excel only** leaving the original legal documents ringfenced. This means cloud solutions are acceptable.

The obligations already live in Excel, which are visible and auditable, addressing the trust concern about black-box tools and the preferred formatting.
...
Given the startup has no in-house engineers, the recommendation for the next step was to proof of concept Microsoft **Power Automate + AI Builder**.

Although this doesn't create an agent for the whole process yet, it is a step forward in automation alongside the data governance work.