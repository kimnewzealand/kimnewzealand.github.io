...
# plot(IDmap) # commenting out to enable knitr
```
...
# saveWidget(IDmap2, "siteIDsleaflet.html") # do not save to Hugo folder
```
...
interT1
# saveWidget(interT1, "interT1.html") # do not save to Hugo folder
```
