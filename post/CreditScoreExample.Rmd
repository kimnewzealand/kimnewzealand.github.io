...
output: 
  html_document
featuredImage: "img/portfolio/credit.png"
# showonlyimage : false
weight : 8    
---
...
The following variables appear to be lead higher risk of default:  
...
In the last two models, we Convert train and test sets original input data to WOE values. Therefore this tree splits based on woe values, not the bin values as per the first tree fitted on coarse binning of numerical variables. A positive WOE for a bin indicates the proportion of good is higher than the proportion of bad.
...
In this exercise we have included various plots. The woebin_plots are useful for visualising the bins created and associated probabilities. The tree plots are useful for interpretability of tree models.
